...
Additionally, it has been configured to support the Telephony channel
...
- In a terminal, navigate to `samples/csharp_dotnetcore/03.telephony-qnamaker`
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `samples/csharp_dotnetcore/03.telephony-qnamaker` folder
  - Select `telephony-qnamaker.csproj` file
...
- [QnA Maker Documentation](https://docs.microsoft.com/azure/cognitive-services/qnamaker/overview/overview)
