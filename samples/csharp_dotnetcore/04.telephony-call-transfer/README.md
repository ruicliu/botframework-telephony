...
To test this bot locally, do the following:

1. Open the solution file `CallTransferBot\runtime\ComposerRuntime.sln` in VisualStudio and build it
2. Open this folder in Composer, enable Custom runtime in bot settings, then click "Start Bot"
